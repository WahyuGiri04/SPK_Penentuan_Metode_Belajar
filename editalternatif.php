            ...
            <div class="row">
                ...
                <div class="panel panel-danger">
                        ...
                        <div class="panel-body">
                            <form role="form" action = "edit_alternatif.php" method="post">
                                <div class="form-group">
                                    <label>Masukkan Alternatif</label>
                                    <input hidden name = "id_alternatif" value = "<?php echo $data_sql['id_alternatif'] ?>" type="text" />
                                    <input required name = "nama_alternatif" value = "<?php echo $data_sql['nama_alternatif'] ?>" class="form-control" type="text" />
                                </div>
