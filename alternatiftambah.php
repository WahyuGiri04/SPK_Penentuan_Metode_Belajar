                        ...
                        <div class="panel-body">
                            <form role="form" action = "tambah_alternatif.php" method="post">
                                <div class="form-group">
                                    ...
                                    <input required name = "nama_alternatif" class="form-control" type="text" />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name = "c3" class="form-control">
                                        ...
                                        while($data_c3 = $sql_c3->fetch_assoc()){?>
                                           <option value = "<?php echo $data_c3['nama_sub'] ?>"> <?php echo $data_c3['nama_sub'] ?></option>
                                        <?php   
                                        }
                                        ?>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name = "c7" class="form-control">
                                        ...
                                        while($data_c7 = $sql_c7->fetch_assoc()){?>
                                           <option value = "<?php echo $data_c7['nama_sub'] ?>"> <?php echo $data_c7['nama_sub'] ?></option>
                                        <?php   
                                        }
                                        ?>
                                    </select>
                                ...
                                <div class="form-group">
                                  <a href="alternatif.php"><button type="button" class="btn btn-danger"><i class="fa fa-sign-out"></i> Batal</button></a>
