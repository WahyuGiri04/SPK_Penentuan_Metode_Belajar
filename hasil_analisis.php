...
<?php include "menu.php" ?>
     <div class="content-wrapper">
        <div class="container">
            ...
            <a href="#" class="btn btn-success float-right"><i class="fa fa-arrow-right"></i> Tambah Kriteria</a>
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading text-center">
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <a href="alternatif_kasus.php?id_mapel=<?php echo $id_mapel ?>" class="btn btn-danger "><i class="fa fa-backward"></i> Kembali</a>
                            <a href="perangkingan.php?id_mapel=<?php echo $id_mapel ?>" class="btn btn-success "><i class="fa fa-save"></i> Simpan</a>
